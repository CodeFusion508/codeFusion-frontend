        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 col-12 pb-3">
                <div class="row justify-content-between">
                    <div class="col-sm-3 px-3" v-for="(item, index) in 4" :key="index">
                        <div :class="
                            [
            ...
            <div class="col-md-12 col-sm-12 col-lg-12 col-12">
                <time-line :day="indexContentDay + 1" :listTask="listDays[indexContentDay].task"></time-line>
            </div>
        </div>
    </div>
    <nav-footer />
        ...
        listDays: [
            {
                task: [
                    {
                        title: "Introducción a HTML", content: `En esta lección en video,
            ...
            increíbles.`, hours: "08:00 - 10:00 horas"
                    },
                    {
                        title: "Problemas", content: `En esta sección, te presentaremos una serie de problemas que pondrán a prueba todo lo que aprendiste en la
            sección anterior.
            ...
            y a mejorar tus habilidades.`, hours: "10:00 - 11:00 horas"
                    },
                    {
                        title: "Introducción al Proyecto", content: `En esta sección, los estudiantes aprenderán a crear una página de perfil y un portfolio personalizado
            utilizando
            HTML y CSS.
            ...
            en el desarrollo web.`, hours: "11:00 - 12:00 horas"
                    },
                    {
                        title: "Lección de HTML avanzado", content: `En esta sección, los estudiantes continuarán su aprendizaje de HTML y se enfocarán en conceptos más avanzados
            ...
            y su uso en el desarrollo web.`, hours: "12:00 - 13:00 horas"
                    },
                    {
                        title: " Solución en video del proyecto", content: `En esta sección, los estudiantes tendrán acceso a un video instructivo que les ayudará a resolver cualquier
            ...
            o desean profundizar en su conocimiento del desarrollo web.`,
                    ...
                    {
                        title: "Última lección de HTML en video", content: `En esta sección final, los estudiantes tendrán la oportunidad de profundizar en su comprensión de HTML y
