    ...
    <div class="col m-3">
      <div class="card bg-dark-subtle border-0 shadow-sm">
        <div class="card-body">
          ...
          <hr>
          <p class="card-text text-white">
            CSS (Cascading Style Sheets) es un lenguaje de estilo utilizado para describir la presentación de un
    ...
    <div class="col m-3">
      <div class="card bg-dark-subtle border-0 shadow-sm">
        <div class="card-body">
          ...
          <hr>
          <p class="card-text text-white">
            JavaScript es un lenguaje de programación utilizado principalmente para crear páginas web interactivas y
            aplicaciones web,
    ...
    <div class="col m-3">
      <div class="card bg-dark-subtle border-0 shadow-sm">
        <div class="card-body">
          ...
          <hr>
          <p class="card-text text-white">
            React CDN es una herramienta que ayuda a los desarrolladores a usar la biblioteca de JavaScript React
    ...
    <div class="col m-3">
      <div class="card bg-dark-subtle border-0 shadow-sm">
        <div class="card-body">
          ...
          <hr>
          <p class="card-text text-white">
            Redux es una herramienta que ayuda a los desarrolladores a manejar la información y eventos de la aplicación
