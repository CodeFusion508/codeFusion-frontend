    ...
    <main>
        <div class="container">
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm col-6">
                                    <div class="circle-wrap">
                                        <div class="circle">
                                            <div class="mask half">
                                                <div class="fill" :style="{ ...getPorcentProgress }"></div>
                                            </div>
                ...
                <div class="col-sm-6 col-12 row justify-content-center d-flex align-items-center content-progress-bar">
                ...
                <div class="card" style="width: 100%; margin-top: 25px; margin-bottom: 75px;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-center" >
                            <div class="col-sm-6 col-12" >
                                <button class="btn btn-primary form-control" >Leer la historia</button>
                            </div>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    computed: {
        getPorcentProgress() {
            const porcentFull = (this.fullPorcent.progress * 100) / this.fullPorcent.full
            const porcentPixel = 150 * (porcentFull / 100)
            return { clip: `rect(0px, ${porcentPixel}px, 150px, 0px)` }
        }
    },
}
</script>